...
public class CharacterController2D : MonoBehaviour {
    ...
    private const float THRESHOLD = .0001f;
    ...
    private void Move(Vector2 deltaMovement)
    {
        ...
        if (Time.deltaTime > 0) _velocity = deltaMovement / Time.deltaTime;
    ...
    {
        // if (StandingOn != null) Debug.Log("Handling platform - StandingOn:" + StandingOn.transform);
        ...
        if (StandingOn != null)
        {
            ...
            if (moveDistance != Vector3.zero) transform.Translate(moveDistance, Space.World);
    ...
    private void MoveHorizontally(ref Vector2 deltaMovement)
    {
        ...
        for (var i=0; i<TotalHorizontalRays; i++)
        {
            ...
            if (i == 0 && HandleHorizontalSlope(ref deltaMovement, Vector2.Angle(rayCastHit.normal, Vector2.up), isGoingRight)) break;
            ...
            if (rayDistance < SkinWidth + THRESHOLD) break;
        }
    ...
    private void MoveVertically(ref Vector2 deltaMovement)
    {
        ...
        for (var i=0; i < TotalVerticalRays; i++)
        {
            ...
            if (!isGoingUp && deltaMovement.y > THRESHOLD)
            {
    ...
    private void HandleVerticalSlope(ref Vector2 deltaMovement)
    {
        ...
        if (Mathf.Abs(angle) < THRESHOLD) return;
